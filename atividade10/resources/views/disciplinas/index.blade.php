...
@extends('templates.main', ['titulo' => "Disciplinas", 'rota' => "disciplinas.create", 'permission' => $permissions['disciplinas.create']])
            ...
            <table class="table align-middle caption-top table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            @if($permissions['disciplinas.edit'])
                            ...
                            @endif
                            @if($permissions['disciplinas.show'])
                            ...
                            @endif
                            @if($permissions['disciplinas.destroy'])
