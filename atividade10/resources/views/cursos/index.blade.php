...
@extends('templates.main', ['titulo' => "Cursos", 'rota' => "cursos.create", 'permission' => $permissions['cursos.create']])
            ...
            <table class="table align-middle caption-top table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            @if($permissions['cursos.edit'])
                            <a href= "{{ route('cursos.edit', '1') }}" class="btn btn-success">
                            ...
                            @endif
                            @if($permissions['cursos.show'])
                            <a href= "{{ route('cursos.show', '1') }}" class="btn btn-primary">
                        ...
                        <form action="{{ route('cursos.destroy', '1') }}" method="POST" id="form_1">
                            @csrf
                            @method('DELETE')
                        </form>
                    </tr>
