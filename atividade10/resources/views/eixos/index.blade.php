...
@extends('templates.main', ['titulo' => "Eixos", 'rota' => "eixos.create", 'permission' => $permissions['eixos.create']])
            ...
            <table class="table align-middle caption-top table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            @if($permissions['eixos.edit'])
                            <a href= "{{ route('eixos.edit', '1') }}" class="btn btn-success">
                            ...
                            @endif
                            @if($permissions['eixos.show'])
                            <a href= "{{ route('eixos.show', '1') }}" class="btn btn-primary">
                        ...
                        <form action="{{ route('eixos.destroy', '1') }}" method="POST" id="form_1">
                            @csrf
                            @method('DELETE')
                        </form>
                    </tr>
